...
import me.binf.web.core.Constant;
...
public class CustomIncludePage implements TemplateDirectiveModel {
	...
	public void execute(final Environment env, Map params,
		...
		String html =  null;
        try {
            html =  genHtml(wrappedRequest, wrappedResponse, printWriter, strPath, qs);
        }   catch (Exception e){
    ...
    private String genHtml(final HttpServletRequest wrappedRequest, final ResponseWrapper wrappedResponse,
                           final PrintWriter printWriter, final String url, final String qs) throws ServletException, IOException{
